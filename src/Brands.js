...
const brands = [
  ...
  { name: "Meserati", logo: "./MESERATI.jpg"},
  { name: "mini", logo: "./MINI.jpg"},
  { name: "Force Motors", logo: "./FORCE-MOTORS.jpg"},
  { name: "gelly", logo: "./GELLY.jpg"},
  { name: "Chery", logo: "./CHERY.jpg"},
  { name: "Rimac", logo: "./RIMAC.jpg"},
  { name: "MG", logo: "./MG.jpg"},
  { name: "Smart", logo: "./SMART.jpg"},
  { name: "Opel", logo: "./OPEL.jpg"},
  { name: "Maybach", logo: "./MAYBACH.jpg"},
  { name: "Hindustan Motors", logo: "./HINDUSTAN-MOTORS.jpg"},
  { name: "Ashok Leyland", logo: "./ASHOK-LEYLAND.jpg"},
  { name: "Polestar", logo: "./POLESTAR.jpg"},
  { name: "Rivian", logo: "./RIVIAN.jpg"},
  { name: "Lucid Motors", logo: "./LUCID-MOTORS.jpg"},
