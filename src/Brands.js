...
const brands = [
  ...
  { name: "LandRover", logo: "./LANDROVER.jpg" },
  ...
  { name: "AstonMartin", logo: "./ASTON-MARTIN.jpg" },
  ...
  { name: "AlfaRomeo", logo: "./ALFA-ROMEO.png" },
  ...
  { name: "ForceMotors", logo: "./FORCE-MOTORS.png"},
  ...
  { name: "HindustanMotors", logo: "./HINDUSTAN-MOTORS.png"},
  { name: "AshokLeyland", logo: "./ASHOK-LEYLAND.jpg"},
  { name: "Polestar", logo: "./POLESTAR.webp"},
  { name: "Rivian", logo: "./RIVIAN.png"},
  { name: "LucidMotors", logo: "./LUCID-MOTORS.webp"},
